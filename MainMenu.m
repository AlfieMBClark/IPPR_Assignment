function MainMenu()
    ...
    %btns
    uibutton(fig, 'push', 'Text', 'Rubber Nitrile', 'FontSize', 16, 'FontWeight', 'bold', 'BackgroundColor', [0.09 0.60 0.99], 'FontColor', [1 1 1], 'Position', [x1 y1 btnW btnH], 'ButtonPushedFcn', @openRubberNitrile);
    uibutton(fig, 'push', 'Text', 'Latex', 'FontSize', 16, 'FontWeight', 'bold', 'BackgroundColor', [0.31 0.56 0.78], 'FontColor', [1 1 1], 'Position', [x2 y1 btnW btnH], 'ButtonPushedFcn', @openLatex);
    uibutton(fig, 'push', 'Text', 'Nylon', 'FontSize', 16, 'FontWeight', 'bold', 'BackgroundColor', [0.25 0.50 0.72], 'FontColor', [1 1 1], 'Position', [x1 y2 btnW btnH], 'ButtonPushedFcn', @(~,~)showComingSoon('Nylon'));
    uibutton(fig, 'push', 'Text', 'Cotton', 'FontSize', 16, 'FontWeight', 'bold', 'BackgroundColor', [0.28 0.53 0.75], 'FontColor', [1 1 1], 'Position', [x2 y2 btnW btnH], 'ButtonPushedFcn', @(~,~)showComingSoon('Cotton'));
